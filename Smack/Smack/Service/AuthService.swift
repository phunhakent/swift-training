...
class AuthService {
    ...
    func createUser(haveName name: String, andEmail email: String, andAvatar avatarName: String, withColor avatarColor: String, completion: @escaping CompletionHandler) {
        let body: [String: Any] = [
            "name": name,
